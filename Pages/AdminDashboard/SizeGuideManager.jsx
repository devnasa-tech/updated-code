            ...
            <div className="mb-12">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-6 border rounded-lg bg-gray-50">
                    <div>
                         ...
                         <input id="image" type="file" accept="image/*" {...register('image', { required: "An image is required" })} className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:font-semibold file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200" />
                    ...
                    <button type="submit" disabled={isSubmitting} className="px-6 py-2 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600 disabled:opacity-70 flex items-center">
                 ...
                 {isLoading ? <p>Loading charts...</p> : (
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {charts.length > 0 ? charts.map(chart => (
                            <div key={chart._id} className="relative group border rounded-lg overflow-hidden">
