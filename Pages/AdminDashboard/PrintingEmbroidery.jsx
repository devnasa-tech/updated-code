...
// Main LexicalEditor component (পরিবর্তিত)
            ...
            <div className="border border-gray-300 rounded-lg">
              ...
              <div className="relative">
                <RichTextPlugin
                  ...
                  placeholder={<div className="text-gray-400 absolute top-4 left-4 pointer-events-none">Enter Printing & Embroidery details...</div>}
                />
                <OnChangePlugin
