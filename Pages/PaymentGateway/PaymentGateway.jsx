...
import { FiCreditCard, FiLock, FiCheckCircle, FiAlertTriangle, FiLoader } from 'react-icons/fi';
    ...
    return (
        <button
            ...
            className={`flex items-center w-full sm:w-1/2 lg:w-full p-4 rounded-lg border-2 transition-all duration-200 ${
                isSelected ? 'border-yellow-400 bg-yellow-50' : 'border-gray-300 hover:border-gray-400'
            }`}
        >
            {icon}
            <span className={`ml-4 font-semibold ${isSelected ? 'text-yellow-700' : 'text-gray-700'}`}>{label}</span>
        </button>
    );
};

const PaymentGateway = ({ amount = 0, currency = 'USD', onPaymentSuccess, onPaymentError }) => {
    ...
    return (
        <div className="max-w-6xl mt-7">
            <div className="">
                <div className="mb-4">
                        <h1 className="text-2xl font-bold text-gray-800 mb-2">Secure Payment</h1>
                        <p className="text-gray-600">Complete your purchase for {currencySymbol}{amount.toFixed(2)}</p>
                    </div>
                <div className="bg-white  rounded-2xl ">
                        ...
                        <div className="space-y-6 border-t pt-6">
                            <div>
                                ...
                                <input 
                                    ...
                                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none transition-all ${
                                        errors.number ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-yellow-200 focus:border-yellow-400'
                                    }`} 
                                />
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none transition-all ${
                                        errors.name ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-yellow-200 focus:border-yellow-400'
                                    }`} 
                                />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        maxLength="5" 
                                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none transition-all ${
                                            errors.expiry ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-yellow-200 focus:border-yellow-400'
                                        }`} 
                                    />
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        maxLength="4" 
                                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none transition-all ${
                                            errors.cvc ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-yellow-200 focus:border-yellow-400'
                                        }`} 
                                    />
                    ...
                    {paymentStatus === 'error' && (
                        <div className="mt-6 p-4 bg-red-50 border border-red-200 text-red-700 rounded-lg flex items-center">
                            ...
                            <span>Payment failed. Please check your details and try again.</span>
                        </div>
                    )}
                    ...
                    >
                        ...
                        <span className="text-lg">
                            {isProcessing ? 'Processing...' : `Pay ${currencySymbol}${amount.toFixed(2)}`}
                        </span>
                    </button>
