...
const CommentForm = () => {
  ...
  const inputStyles = "w-full bg-white border border-gray-200 px-2 py-1 text-gray-700 placeholder-gray-400 focus:outline-none focus:border-gray-400 transition-colors";
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="flex items-center mb-8">
            ...
            />
            <label htmlFor="save-info" className="ml-3 block text-sm text-gray-700 select-none">
